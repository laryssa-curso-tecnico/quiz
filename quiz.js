document.addEventListener('DOMContentLoaded', () => {
    ...
    const perguntas = [
        ...
        { pergunta: "Qual destes animais é um mamifero aquático?", opcoes: ["Tubarão", "Baleia-azul", "Polvo", "Camarão"], resposta: "Baleia-azul"},
        ...
        {pergunta: "Que animal é símbolo nacional da Austrália ? ", opcoes: ["Canguru", "Koala", "Emu", "Dingo"] , resposta: "Canguru" }
    ];
    ...
    function mostrarResultado() {
        ...
        resultadoHTML += '<br><br><h2>Resposta:</h2>';
